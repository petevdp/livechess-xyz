...
export const NumberFieldLabel = <T extends ValidComponent = 'div'>(props: PolymorphicProps<T, numberFieldLabelProps<T>>) => {
...
export const NumberFieldDescription = <T extends ValidComponent = 'div'>(props: PolymorphicProps<T, numberFieldDescriptionProps<T>>) => {
	const [local, rest] = splitProps(props as numberFieldDescriptionProps, ['class'])

	return <NumberFieldPrimitive.Description class={cn(textfieldLabel({ description: true, label: false }), local.class)} {...rest} />
}
...
export const NumberFieldErrorMessage = <T extends ValidComponent = 'div'>(props: PolymorphicProps<T, numberFieldErrorMessageProps<T>>) => {
...
export const NumberFieldInput = <T extends ValidComponent = 'input'>(props: PolymorphicProps<T, VoidProps<numberFieldInputProps<T>>>) => {
...
export const NumberFieldDecrementTrigger = <T extends ValidComponent = 'button'>(
	...
	return (
		<NumberFieldPrimitive.DecrementTrigger
			class={cn('absolute left-0 top-1/2 -translate-y-1/2 p-3 disabled:cursor-not-allowed disabled:opacity-20', local.class)}
			{...rest}
		>
...
export const NumberFieldIncrementTrigger = <T extends ValidComponent = 'button'>(
	...
	return (
		<NumberFieldPrimitive.IncrementTrigger
			class={cn('absolute right-0 top-1/2 -translate-y-1/2 p-3 disabled:cursor-not-allowed disabled:opacity-20', local.class)}
			{...rest}
		>
			<svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 24 24">
